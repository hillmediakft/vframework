...
class Upload {
     ...
     *
     * By default, the language is hungary ("hu_HU")
     *
     * @access public
     * @var array
     */
    ...
    function __construct($file, $lang = 'hu_HU') {
		...
		$this->translation['file_error']                  = 'Hibás fájl. Kérem próbálja újra.';
		$this->translation['local_file_missing']          = 'A lokális fájl nem létezik.';
		$this->translation['local_file_not_readable']     = 'A lokális fájl nem olvasható.';
		$this->translation['uploaded_too_big_ini']        = 'Hiba a fájl feltöltésekor (az elküldött fájl túllépi a php.ini-ben beállított upload_max_filesize értéket).';
		$this->translation['uploaded_too_big_html']       = 'Hiba a fájl feltöltésekor (az elküldött fájl túllépi a HTML űrlapban beállított MAX_FILE_SIZE értéket).';
		$this->translation['uploaded_partial']            = 'Hiba a fájl feltöltésekor (a feltöltött fájl csak egy része került feltöltésre).';
		$this->translation['uploaded_missing']            = 'Hiba a fájl feltöltésekor (nem volt feltöltve fájl).';
		$this->translation['uploaded_no_tmp_dir']         = 'Hiba a fájl feltöltésekor (hiányzik az ideiglenes mappa).';
		$this->translation['uploaded_cant_write']         = 'Hiba a fájl feltöltésekor (failed to write file to disk).';
		$this->translation['uploaded_err_extension']      = 'Hiba a fájl feltöltésekor (a fájl feltöltése megállt egy bővítmény miatt).';
		$this->translation['uploaded_unknown']            = 'Hiba a fájl feltöltésekor (ismeretlen hibakód).';
		$this->translation['try_again']                   = 'Hiba a fájl feltöltésekor.  Kérem próbálja újra.';
		$this->translation['file_too_big']                = 'A fájl túl nagy.';
		$this->translation['no_mime']                     = 'Nem határozható meg a MIME típus.';
		$this->translation['incorrect_file']              = 'Nem megfelelő fájltípus.';
		$this->translation['image_too_wide']              = 'A kép túl széles.';
		$this->translation['image_too_narrow']            = 'A kép túl keskeny.';
		$this->translation['image_too_high']              = 'A kép túl magas.';
		$this->translation['image_too_short']             = 'A kép túl alacsony.';
		$this->translation['ratio_too_high']              = 'A kép aránya túl nagy (a kép túl széles).';
		$this->translation['ratio_too_low']               = 'A kép aránya túl kicsi (a kép túl magas).';
		$this->translation['too_many_pixels']             = 'A kép túl sok képpontot tartalmaz.';
		$this->translation['not_enough_pixels']           = 'A kép túl kevés képpontot tartalmaz.';
		$this->translation['file_not_uploaded']           = 'A fájl nem lett feltöltve. Nem lehet folytatni a folyamatot.';
		$this->translation['already_exists']              = '%s már létezik. Kérem változtassa meg a fájlnevet.';
		$this->translation['temp_file_missing']           = 'Nem megfelelő ideiglenes forrásfájl. Nem lehet folytatni a folyamatot.';
		$this->translation['source_missing']              = 'Nem megfelelő feltöltött forrásfájl. Nem lehet folytatni a folyamatot.';
		$this->translation['destination_dir']             = 'A célkönyvtár nem hozható létre. Nem lehet folytatni a folyamatot.';
		$this->translation['destination_dir_missing']     = 'A célkönyvtár nem létezik. Nem lehet folytatni a folyamatot.';
		$this->translation['destination_path_not_dir']    = 'Az elérési útvonal nem mappára mutat. Nem lehet folytatni a folyamatot.';
		$this->translation['destination_dir_write']       = 'A célkönyvtár nem tehető írhatóvá. Nem lehet folytatni a folyamatot.';
		$this->translation['destination_path_write']      = 'Az elérési útvonal nem írható. Nem lehet folytatni a folyamatot.';
		$this->translation['temp_file']                   = 'Az ideiglenes fájl nem hozható létre. Nem lehet folytatni a folyamatot.';
		$this->translation['source_not_readable']         = 'A forrásfájl nem olvasható. Nem lehet folytatni a folyamatot.';
		$this->translation['no_create_support']           = 'Nem hozható létre %s fájlból.';
		$this->translation['create_error']                = 'Hiba történt a %s kép forrásból való létrehozásakor.';
		$this->translation['source_invalid']              = 'Nem olvasható a kép forrása. Képet adott meg?.';
		$this->translation['gd_missing']                  = 'A GD könyvtár valószínűleg hiányzik.';
		$this->translation['watermark_no_create_support'] = '%s típusból való létrehozá nem támogatott, nem olvasható a vízjel.';
		$this->translation['watermark_create_error']      = '%s típus olvasása nem támogatott, nem hozható létre vízjel.';
		$this->translation['watermark_invalid']           = 'Ismeretlen kép formátum, nem olvasható a vízjel.';
		$this->translation['file_create']                 = '%s fájltípus létrehozása nem támogatott.';
		$this->translation['no_conversion_type']          = 'Konverzió típusa nem lett megadva.';
		$this->translation['copy_failed']                 = 'Hiba történt a fájl szerverre való másolásakor. copy() sikertelen.';
