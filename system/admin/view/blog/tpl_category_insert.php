				...
				<!-- BEGIN PAGE HEADER-->
					...
					<div class="page-bar">
						<ul class="page-breadcrumb">
							...
							<li><a href="admin/blog/category_update">Kategória hozzáadása</a></li>
						</ul>
					</div>
							...
							<div class="row">	
								<div class="col-md-12">						
									<form action="" method="POST" id="category_insert_form" enctype="multipart/form-data">	
										...
										<div class="space10"></div>
										<button class="btn green submit" type="submit" value="submit" name="submit_category_insert">Kategória hozzáadása <i class="fa fa-check"></i></button>
									</form>
								</div>
							</div>	
