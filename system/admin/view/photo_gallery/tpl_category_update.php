				...
				<!-- BEGIN PAGE HEADER-->
					...
					<div class="page-bar">
						<ul class="page-breadcrumb">
							...
							<li><a href="admin/photo_gallery/category_update">Kategória módosítáas</a></li>
						</ul>
					</div>
								...
								<div class="col-md-12">						
									<form action="" method="POST" id="category_update_form" enctype="multipart/form-data">	
										...
										<div class="form-group">
											...
											<input type="text" name="category_name" id="category_name" value="<?php echo $content[0]['category_name']?>" class="form-control input-xlarge" />
										</div>
