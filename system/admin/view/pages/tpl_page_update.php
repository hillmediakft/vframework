				...
				<div class="portlet">
                        ...
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <?php echo $page['page_title'];?> oldal szerkesztése
                            </div>
                            <div class="actions">
					    ...
					    <div class="portlet-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type='text' name='page_title' class='form-control' value="<?php echo $page['page_title'] ?>" disabled=''>
                            </div>

                            <div class="form-group">
                                <label for="page_metatitle">Az oldal címe</label>	
                                <input type='text' name='page_metatitle' class='form-control' value="<?php echo $page['page_metatitle'] ?>"/>
                            </div>

                            <div class="form-group">
                                <label for="page_metadescription">Az oldal leírása</label>	
                                <input type='text' name='page_metadescription' class='form-control' value="<?php echo $page['page_metadescription'] ?>">
                            </div>

                            <div class="form-group">
                                <label for="page_metakeywords">Kulcsszavak</label>
                                <input type='text' name='page_metakeywords' class='form-control' value="<?php echo $page['page_metakeywords'] ?>">
                            </div>

                            <div class="form-group">
                                <label for="page_body">Tartalom</label>
                                <textarea type="text" name="page_body" class="form-control"><?php echo $page['page_body'] ?></textarea>
                            </div>
