...
class Newsletter extends Admin_controller {
	...
	public function index()
	{
		...
		$this->view->add_links(array('select2', 'datatable', 'bootbox', 'vframework', 'newsletter_eventsource'));
...
//$this->view->debug(true);	
	...
	public function newsletter_stats()
	{
		...
		$this->view->add_links(array('select2', 'datatable', 'bootbox', 'vframework', 'newsletter_stats'));
